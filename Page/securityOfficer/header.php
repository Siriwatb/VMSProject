...
}else if($_SESSION['Position'] != "เจ้าหน้าที่รักษาความปลอดภัย" &&  $_SESSION['checkPermit'] != 'บุคลากร'){
		header("Location: ../../index.php");
}
  ...
  <!-- เมนู -->
    <div class="ui inverted borderless stackable main menu">
      <div class="ui text container">
        <!-- <a class="item" id="btnHome">จัดการข้อมูลการเข้า-ออก</a> -->
        <div class="ui dropdown item">จัดการข้อมูลการเข้า-ออก
          <div class="menu">
            <a href="list-Entry.php" class="item" id="btnEntry">บันทึกเวลาเข้า</a>
      			<a href="list-Exit.php" class="item" id="btnExit">บันทึกเวลาออก</a>
        ...
        <!-- <div class="ui dropdown item">ข้อมูลเกี่ยวกับยานพาหนะ
          <div class="menu">
      			<a class="item" id="btnLoad-Vehicles">ข้อมูลยานพาหนะ</a>
            <a class="item" id="btnLoad-Maintenance">ข้อมูลการตรวจซ่อมบำรุง</a>
          </div>
        </div>
        <a class="item" id="btnLoad-Driver">ข้อมูลพนักงาน</a> -->
...
<div class="ui modal" id='ModalProfile'>
  ...
  <div class="image content">
    ...
    <div class="description">
      ...
      <p>สังกัด : <?php echo $_SESSION['Dept'] ?></p>
...
<div class="ui tiny modal" id='ModalChangePassword'>
  ...
  <!-- ส่วนท้าย footer -->
  <!-- <footer>
    <div class="ui center aligned inverted footer segment">
