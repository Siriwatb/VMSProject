...
require_once '../../../ConfigDB.php';
	...
	if($_POST)
	{
        ...
        $perID = $_SESSION['user_session'];
		$conn->beginTransaction();
      try{

  			$stmt = "INSERT INTO `using`( `Destination`, `Start Date`, `Appointment`, `End Date`, `Start Time`, `End Time`,  `Reason`, `NumPeople`, `PersonnelID`) VALUES 
              ('$Destination','$dateS','$appointment','$dateE',' $startTime','$endTime','$Reason','$NumPeople','$perID')";
