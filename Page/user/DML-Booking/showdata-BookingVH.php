          ...
          <div class="ui equal width form">
              ...
              <div class="required field">
                ...
                <div class="ui calendar" >
                  <div class="ui input left icon">
                    ...
                    <input type="text" placeholder="วันที่เดินทาง" readonly=""  >
                  </div>
                </div>
              </div>
              <div class="required field">
                ...
                <div class="ui calendar" >
                  <div class="ui input left icon">
                    <i class="calendar icon"></i>
                    <input type="text" placeholder="วันที่กลับ" readonly=""  >
                  </div>
                </div>
              </div>
            </div>
            <div class="fields">
              <div class="required field">
                ...
                <div class="ui calendar" >
                  <div class="ui right labeled  input left icon">
                    <i class="time icon"></i>
                    <input type="text" placeholder="เวลาออกเดินทาง" readonly=""  >
              ...
              <div class="required field">
                ...
                <div class="ui calendar" >
                  <div class="ui right labeled  input left icon">
                    <i class="time icon"></i>
                    <input type="text" placeholder="เวลากลับ"  readonly="" >
                    <div class="ui basic label">
                      น.
                    </div>
                  </div>
            ...
            <div class="fields">
              ...
              <div class="field">
                ...
                <input type="text" placeholder="จำนวนที่นั่ง" readonly="" >
              </div>
            ...
            <div class="fields">
              ...
              <div class="required field">
                ...
                <textarea rows="4" placeholder="จุดนัดขึ้นรถ" readonly="" ></textarea>
              </div>
              <div class="required field">
                <label>จุดประสงค์การเดินทาง</label>
                <textarea rows="4" placeholder="ระบุจุดประสงค์การเดินทาง" readonly="" ></textarea>
              </div>
            </div>
            <!-- <div class="fields">
