...
<div class="TableVHO">
  <h1 class="ui block header">
    <div class="fontMitr">
      ข้อมูลเจ้าหน้าที่ฝ่ายยานพาหนะ คณะครุศาสตร์
    </div>
  </h1>
        ...
        <thead>
          ...
          <tbody>
            <?php
              ...
              // $Office = $_POST['office'];
              $tblVehOff = $conn->prepare("SELECT `OfficerID`, ov.`Name` as name, `Position`, fac.Name as faculty FROM `officer_vehicles` as ov join faculty as fac ON ov.office = fac.ID  where office=4 "); 
              //  WHERE Office = :office
