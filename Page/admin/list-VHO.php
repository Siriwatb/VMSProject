    ...
    <table class="ui celled table" cellspacing="0" width="100%" id="VHO-Table">
      ...
      <tbody>
        <?php
              ...
              // $Office = $_POST['office'];
              $tblVehOff = $conn->prepare("SELECT OfficerID, Username, vho.Name as name,Address,Telephone_number,Position,f.Name as faculty FROM officer_vehicles as vho join faculty as f on vho.Office = f.ID "); 
              //  WHERE Office = :office
            ...
            <div class="ui equal width form">
              <div class="two fields">
                <div class="required field">
                  ...
                  <div class="ui icon input" id="loadingCheck">
                    <input type="text" placeholder="รหัสเจ้าหน้าที่" id="OfficerID" name="OfficerID" > 
                    <!-- onblur="checkAvailabilityOFF()" -->
              ...
              <div class="two fields">
                <div class="required field">
                  ...
                  <div class="ui icon input" id="loadingCheck">
                    <input type="text" placeholder="ชื่อผู้ใช้เข้าสู่ระบบ" id="username" name="username">
                    <!-- onblur="checkAvailabilityUserID()" -->
