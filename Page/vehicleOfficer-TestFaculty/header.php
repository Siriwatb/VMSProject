<?php
  ...
  }else if($_SESSION['checkPermit'] != "เจ้าหน้าที่ฝ่ายยานพาหนะ" && $_SESSION['Position']!='เจ้าหน้าที่ฝ่ายยานพาหนะ' && $_SESSION['Office']=='ส่วนกลาง') {
  	header("Location: ../../index.php");
  }
...
<html lang="th">
  <head>
    <meta charset="utf-8">
    <title>vehicleOfficer- <?php echo $_SESSION['Office'] ?> PAGE</title>
  ...
  <!-- เมนู -->
    <div class="ui inverted borderless stackable main menu">
      <div class="ui text container">
        <a href="index.php" class="item" id="btnHome">หน้าแรก</a>
